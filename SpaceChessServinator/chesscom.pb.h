...
#ifndef PROTOBUF_INCLUDED_chesscom_2eproto
#define PROTOBUF_INCLUDED_chesscom_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_chesscom_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_chesscom_2eproto {
...
namespace google {
namespace protobuf {
template<> ::chesscom::MathReply* Arena::CreateMaybeMessage<::chesscom::MathReply>(Arena*);
template<> ::chesscom::MathRequest* Arena::CreateMaybeMessage<::chesscom::MathRequest>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace chesscom {
...
class MathRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:chesscom.MathRequest) */ {
 public:
  MathRequest();
  virtual ~MathRequest();
  ...
  // @@protoc_insertion_point(class_scope:chesscom.MathRequest)
 private:
  class HasBitSetters;
  ...
  friend struct ::TableStruct_chesscom_2eproto;
};
// -------------------------------------------------------------------

class MathReply final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:chesscom.MathReply) */ {
 public:
  MathReply();
  virtual ~MathReply();
  ...
  // @@protoc_insertion_point(class_scope:chesscom.MathReply)
 private:
  class HasBitSetters;
...
inline ::google::protobuf::int32 MathRequest::a() const {
  // @@protoc_insertion_point(field_get:chesscom.MathRequest.a)
  return a_;
}
inline void MathRequest::set_a(::google::protobuf::int32 value) {
  
  a_ = value;
  // @@protoc_insertion_point(field_set:chesscom.MathRequest.a)
}
...
inline ::google::protobuf::int32 MathRequest::b() const {
  // @@protoc_insertion_point(field_get:chesscom.MathRequest.b)
  return b_;
}
inline void MathRequest::set_b(::google::protobuf::int32 value) {
  
  b_ = value;
  // @@protoc_insertion_point(field_set:chesscom.MathRequest.b)
}
...
inline ::google::protobuf::int32 MathReply::result() const {
  // @@protoc_insertion_point(field_get:chesscom.MathReply.result)
  return result_;
}
inline void MathReply::set_result(::google::protobuf::int32 value) {
  
  result_ = value;
  // @@protoc_insertion_point(field_set:chesscom.MathReply.result)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_chesscom_2eproto
